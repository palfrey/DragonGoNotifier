...
public class DragonAccountAuthenticator extends AbstractAccountAuthenticator {
    private final Context mContext;

    public DragonAccountAuthenticator(Context context) {
        super(context);
        mContext = context;
    }
    ...
    public Bundle addAccount(AccountAuthenticatorResponse response, String accountType, String authTokenType, String[] requiredFeatures, Bundle options) throws NetworkErrorException {
        final Intent intent = new Intent(mContext, DragonAuthenticatorActivity.class);
        ...
        if (TextUtils.isEmpty(authToken)) {
            ...
            if (password != null) {
                try {
                    ...
                    authToken = loginResult.getSessionCode();
                } catch (IOException e) {
                    e.printStackTrace();
                }
            }
